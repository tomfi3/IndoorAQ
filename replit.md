...
**Approach**: Auto-load data file with diary file for annotations and pre-calculated typical day averages
- **Decision**: Auto-load specific data file, diary file, and typical day averages from attached_assets folder
- **Rationale**: Simplifies workflow for single-dataset use case; admin can edit diary file to manage annotations; pre-calculated typical day data improves performance
- **Data File**: `attached_assets/73 Chestnut Road - Full Data_1763474740403.xlsx` (times adjusted -90 minutes)
- **Diary File**: `attached_assets/diary_1763478604977.xlsx` with Datetime and Action columns (16 entries from Nov 11-18)
- **Typical Day File**: `attached_assets/typical_day_averages.xlsx` (96 time slots × 6 parameters, generated by preprocess_typical_day.py)
